...
// 键盘背景色
val KeyboardBackground = Color(0xFFE8EAED)  // 浅灰色背景
val KeyboardBackgroundDark = Color(0xFF202124)  // 深色模式背景

// 按键颜色
val KeyBackground = Color(0xFFFFFFFF)  // 白色按键
val KeyBackgroundDark = Color(0xFF35363A)  // 深色模式按键

// 特殊按键颜色（如 Shift, Delete, Enter）
val SpecialKeyBackground = Color(0xFFD3E3FD)  // 浅蓝色
